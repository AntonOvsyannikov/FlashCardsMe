...
Для начала необходимо установить среду исполнения Java 8. На текущий момент последняя официальная версия среды исполнения находится здесь.

Затем необходимо скачать jar файл с программой здесь.

Можно также заглянуть в директорию “Sample Decks” репозитория и скачать примеры колод.
...
В двух следующих небольших руководствах будет рассказано как работать с готовой колодой карточек, а также создавать свои собственные колоды для FlashCardsMe.

## Урок 1 - Обучение по готовой колоде

### Установка и запуск

Для начала необходимо скачать программу FlashCardsMe. Для этого необходимо скачать jar файл, а так же установить среду исполнения Java 8 (например Java SE Runtime Environment 8u151).

Также необходимо скачать здесь простую колоду, при помощи которой мы выучим названия столиц 10 штатов США.
...
Далее нажимаем кнопку “Edit: Classes”. Нажимаем кнопку (+) и вводим название класса “South states”. В качестве условия вводим что поле “*class” должно содержать (быть равным) “South”. Повторяем процедуру для “North classes”.![](images/image13.png)
